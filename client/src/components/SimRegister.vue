<template>
  <div class="">
    ...
    <div class="mt-2 bg-gray-600 rounded-lg p-2" :style="{
      height: areaType === 'area' || simulationTypeSelected === 'multi'
        ? '500px'
        : '1px'
    }">
      ...
      <!-- <div :ref="mapId" :id="mapId" class="map" style="height: 600px"></div> -->
