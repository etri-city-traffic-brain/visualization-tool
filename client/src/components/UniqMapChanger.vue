<template>
  <div class="inline">
    <button class="bg-indigo-300 text-xs rounded p-1 text-black" @click="changeMap(0)" size="sm"> 일반 </button>
    <!-- <b-button @click="changeMap(1)"> 그레이</b-button> -->
    <button class="bg-indigo-300 text-xs rounded p-1 text-black" @click="changeMap(2)" size="sm"> 야간</button>
    <button class="bg-indigo-300 text-xs rounded p-1 text-black" @click="changeMap(3)" size="sm"> 위성 </button>
  </div>
</template>
